...
def parse_args():
    ...
    parser.add_argument("--calculate-similarity", "-c", help=("Calculate Tanimoto similarity"), type=bool, default=False)
...
if __name__ == "__main__":
    ...
    if args.calculate_similarity:
        similarity_df = analysis.calculate_tanimoto_similarity(train)
        similarity_df.to_csv(os.path.join(args.save_directory, 'similarity.tsv'), sep='\t', index=False)
